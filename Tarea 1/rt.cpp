...
Color shade(const Ray &r) {
	...
	double tNew = t / 304.111;

	// std::cout<<"Color value: " << tNew << std::endl;
...
int main(int argc, char *argv[]) {
	...
	{ 
		...
		for(int x = 0; x < w; x++ ) {
			...
			// para el pixel actual, obtener la distancia entre el rayo y la intersección con la escena
			// double dist = giveDist(Ray(camera.o, cameraRayDir.normalize()));
			// double tNew = dist / 304.111;
			...
			// pixelValue = Color (tNew, tNew, tNew);
